 ...
 */
public class SelectableTextHelperLong {
...
//    private int mWindowViewHeight;
    ...
    private SelectableTextHelperLong(@NonNull Builder builder) {
...
//        });
    ...
    private void showSelectView() {
        ...
        if (endLine > layout.getLineCount() || startOffset > layout.getLineCount()) {
            return;
        }
...
//        }
        ...
        public SelectableTextHelperLong build() {
            return new SelectableTextHelperLong(this);
        }
