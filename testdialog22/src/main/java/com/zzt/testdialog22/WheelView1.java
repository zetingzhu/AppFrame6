...
//                LinearGradient mLinearGradient = new LinearGradient(0, 0, 0, itemView.getPaint().getTextSize(), textColorFocus, textColorFocus, Shader.TileMode.CLAMP);
//                itemView.getPaint().setShader(mLinearGradient);
            } else {
                itemView.setTextColor(textColorNormal);
                itemView.setTextSize(textSizeNormal);
//                LinearGradient mLinearGradient = new LinearGradient(0, 0, 0, itemView.getMeasuredHeight(), textColorNormal, textColorNormal, Shader.TileMode.CLAMP);
//                itemView.getPaint().setShader(mLinearGradient);
            }
        }
    }
